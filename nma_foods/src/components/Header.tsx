...
import { Search, User, Menu, Shield, Award, Leaf } from "lucide-react";
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <NavigationMenu className="hidden lg:flex">
            <NavigationMenuList>
              ...
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link to="/blog" className="text-base font-medium px-4 py-2 hover:text-primary transition-colors">
                    Blog
                  </Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
